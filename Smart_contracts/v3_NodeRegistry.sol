    ...
    function getPolicyString(NodeType from, NodeType to) internal pure returns (string memory) { 
        if (from == NodeType.Cloud) {
            ...
            if (to == NodeType.Fog) {
                ...
                return "Cloud->Edge:NO POLICY DEFINED";
            } else if (to == NodeType.Sensor) {
                return "Cloud->Sensor:NO POLICY DEFINED";
            } else if (to == NodeType.Actuator) {
                return "Cloud->Actuator:NO POLICY DEFINED";
            }
            ...
            if (to == NodeType.Cloud) {
                ...
                return "Fog->Sensor:NO POLICY DEFINED";
            } else if (to == NodeType.Actuator) {
                return "Fog->Actuator:NO POLICY DEFINED";
            }   
        } else if (from == NodeType.Edge) {

            if (to == NodeType.Cloud) {
                return "Edge->Cloud:READ";
            } else if (to == NodeType.Fog) {
                return "Edge->Fog:READ,WRITE";
            } else if (to == NodeType.Sensor) {
                return "Edge->Sensor:NO POLICY DEFINED";
            } else if (to == NodeType.Actuator) {
                return "Edge->Actuator:NO POLICY DEFINED";
            }
        } else if (from == NodeType.Sensor) {

            if (to == NodeType.Cloud) {
                return "Sensor->Cloud:NO POLICY DEFINED";
            } else if (to == NodeType.Fog) {
                return "Sensor->Fog:NO POLICY DEFINED";
            } else if (to == NodeType.Edge) {
                return "Sensor->Edge:NO POLICY DEFINED";
            } else if (to == NodeType.Actuator) {
                return "Sensor->Actuator:NO POLICY DEFINED";
            }
        } else if (from == NodeType.Actuator) {

            if (to == NodeType.Cloud) {
                return "Actuator->Cloud:NO POLICY DEFINED";
            } else if (to == NodeType.Fog) {
                return "Actuator->Fog:NO POLICY DEFINED";
            } else if (to == NodeType.Edge) {
                return "Actuator->Edge:NO POLICY DEFINED";
            } else if (to == NodeType.Sensor) {
                return "Actuator->Sensor:NO POLICY DEFINED";
            }
        }
