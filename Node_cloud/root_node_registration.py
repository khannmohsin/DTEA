    ...
    def setup_routes(self):
        ...
        def register_node():
            ...
            if check_smart_contract:
                ...
                return jsonify({"status": "error", "message": "Smart contract not deployed. Wait for admin to upload Smart Contract..."}), 500
            ...
            print("\nChecking Receiving Node Signature...")
                ...
                if result["registered"] == True:
                    ...
                    if status == "success":
                        ...
                        if data["address"] in get_All_validators:
                            ...
                            return jsonify({"status": "success", "message": f"Node {data['address']} is a root chain. It is already registered as a validator."}), 200
                        ...
                        if self.checkValidator(data["signature"]):
                            ...
                            print(f"Waiting for {data['node_id']}:{data['node_name']} to connect to chain network")
                            ...
                            print("Validator Added: self.get_all_validators()")
